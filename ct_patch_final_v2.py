...
start_modal = text.find('<!-- LOGIN MODAL -->')
end_modal = text.find('<!-- SIDEBAR -->', start_modal)

new_modal = r"""<!-- LOGIN MODAL -->
...
end_script = text.find('</script>', start_script) + 9
...
print("SUCCESS: HTML_TEMPLATE updated with Register form, Chart fixes, and mock Slots.")
